...
test('test2: low frequency, idf: normal, tf: row count', async () => {
    const body = {
        "data": {
            "word_count": 4,
            "n_words": 200,
...
test('test3: mid frequency, idf: normal, tf: row count', async () => {
    const body = {
        "data": {
            "word_count": 4,
            "n_words": 200,
...
test('test4: mid frequency , idf: probabilistic, tf: row count', async () => {
    const body = {
        "data": {
            "word_count": 4,
            "n_words": 200,
